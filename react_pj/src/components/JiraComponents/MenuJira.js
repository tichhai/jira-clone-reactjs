        ...
        <div className="menu">
            <div className="account">
                <div className="avatar">
                    <img src={require("../../assets/img/download.jfif")} alt="jira" />
                </div>
            ...
            <div className="control">
                <div>
                    ...
                    <NavLink className="text-dark" activeStyle={{color:'blue'}} to="/jira" activeClassName="active font-weight-bold text-primary" >Jira Board</NavLink>
                </div>
                <div>
